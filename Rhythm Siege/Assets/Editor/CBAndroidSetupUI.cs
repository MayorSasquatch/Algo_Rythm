...
namespace Chartboost {
	public class CBAndroidSetupUI : EditorWindow {
		
		// minimum version of the Google Play Services library project
		public const long MinGmsCoreVersionCode = 4030530;
		
		[MenuItem("Chartboost/Android Setup...", false, 0)]
		    public static void MenuItemCBAndroidSetup() {
		        EditorWindow.GetWindow(typeof(CBAndroidSetupUI));
		    }
		
		[MenuItem("File/Chartboost - Android setup...")]
		    public static void MenuItemFileCBAndroidSetup() {
		        EditorWindow.GetWindow(typeof(CBAndroidSetupUI));
		    }
		
		public const string sTitle = "Chartboost - Android Configuration";
        public const string sBlurb = "To configure Chartboost in this project,\n" +
        ...
        public const string sSetupComplete = "Chartboost configured successfully.";
		
		public CBAndroidSetupUI() {
		}
